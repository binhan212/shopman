...
<html lang="en" >
  <head>
    ...
    <!-- </head> -->
  <div ng-controller="ctdhcontroller">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr dir-paginate="sp in ctdh|filter:textSearch|itemsPerPage:10">
                    ...
                    <td>@{{sp.SoLuong}}</td>
                    <td>@{{sp.MaDH}}</td>
                    <td><button class="btn btn-info" ng-click="showmodal(sp.MaCTDH)">&nbsp;Edit</button></td>
                    <td><button class="btn btn-danger" ng-click="deleteClick(sp.MaCTDH)">&nbsp;Delete</button></td>
                </tr>
            </tbody>
        </table>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="name">MaCTDH:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="ctdh.MaCTDH">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="ctdh.MaSize">
                            </div>
                        </div>
                    </div>   
                </div>
