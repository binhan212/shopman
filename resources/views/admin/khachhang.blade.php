...
<html lang="en" >
  <head>
    ...
    <!-- </head> -->
  <div ng-controller="khachhangcontroller">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr dir-paginate="sp in khachhang|filter:textSearch|itemsPerPage:10">
                    ...
                    <td>@{{sp.TenDN}}</td>
                    <td>@{{sp.MatKhau}}</td>
                    <td><button class="btn btn-info" ng-click="showmodal(sp.MaKH)">&nbsp;Edit</button></td>
                    <td><button class="btn btn-danger" ng-click="deleteClick(sp.MaKH)">&nbsp;Delete</button></td>
                </tr>
            </tbody>
        </table>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="name">MaKH:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="khachhang.MaKH">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="name">TenKH:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="khachhang.TenKH">
                            </div>
                        </div>
                    </div>   
                </div>
