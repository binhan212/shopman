  ...
  <div ng-controller="dmccontroller">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr dir-paginate="sp in dmc|filter:textSearch|itemsPerPage:10">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="dmc.MaDM">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="dmc.TenDM">
                            </div>
                        </div>
                    </div>   
                </div>
