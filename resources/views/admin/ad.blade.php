  ...
  <div ng-controller="adcontroller">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr dir-paginate="sp in ad|filter:textSearch|itemsPerPage:10">
                    ...
                    <td>@{{sp.MatKhau}}</td>
                    <td>@{{sp.TrangThai}}</td>
                    <td><button class="btn btn-info" ng-click="showmodal(sp.MaADMIN)">&nbsp;Edit</button></td>
                    <td><button class="btn btn-danger" ng-click="deleteClick(sp.MaADMIN)">&nbsp;Delete</button></td>
                </tr>
            </tbody>
        </table>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="name">MaADMIN:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="ad.MaADMIN">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="name">TenADMIN:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="ad.TenADMIN">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="name">TenDN:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="ad.TenDN">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            <label for="name">MatKhau:</label>
                            <div>
                                <input type="text" class="form-control" ng-model="ad.MatKhau">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="ad.TrangThai">
                            </div>
                        </div>
                    </div>
                </div>
