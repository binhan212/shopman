  ...
  <div ng-controller="sizecontroller">
    ...
    <div>
        <table class="table table-border">
            ...
            <tbody>
                <tr dir-paginate="sp in size|filter:textSearch|itemsPerPage:10">
                    <td>@{{($index+1)+(pagination.current -1)*10}}</td>
                    <td>@{{sp.MaSize}}</td>
                    <td>@{{sp.TenSize}}</td>
                    <td>@{{sp.SoLuongTonKho}}</td>
                    <td>@{{sp.MaMS}}</td>
                    <td><button class="btn btn-info" ng-click="showmodal(sp.MaSize)">&nbsp;Edit</button></td>
                    <td><button class="btn btn-danger" ng-click="deleteClick(sp.MaSize)">&nbsp;Delete</button></td>
                </tr>
            </tbody>
        </table>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="size.MaSize">
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="text" class="form-control" ng-model="size.TenSize">
                            </div>
                        </div>
                    </div>   
                </div>
