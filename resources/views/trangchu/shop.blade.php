...
<html lang="en" ng-app='myapp'>
  ...
  <body class="goto-here" ng-controller="shopcontroller">
        @include('includes_TC.header')

        <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread" style="font-size: 34px;float: left;padding-top: 22px;color: #82ae46;">@{{dml.TenDM}}</h1>
          </div>
        </div>
      </div>
    </div>
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					<li ng-repeat="s in dmc" style="padding: 0px 23px;">
                        <span style="color:none;">
                            <a href="#" ng-click="changeKindOf(s.MaDM)">
                                @{{s.TenDM}}
                            </a>
                        </span>
