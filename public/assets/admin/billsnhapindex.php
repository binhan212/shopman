...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh Sách bills nhập
                            </div>
                            <div class="card-body" ng-app='myapp' ng-controller='getBillsnhap'>
        ...
        <script src="./Controller/getBillsnhap.js"></script>
